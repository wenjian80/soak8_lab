...
kubectl create secret docker-registry conregsecret --docker-server=container-registry.oracle.com --docker-username=$1 --docker-password=$2 --docker-email='boon.jian.lim@oracle.com' -n soans
...
./create-rcu-schema.sh -s SOA1 -t soaessosb -d database.soans.svc.cluster.local:1521/PDB1.subnet11251534.vcn11251534.oraclevcn.com -p conregsecret -i container-registry.oracle.com/middleware/soasuite:12.2.1.4 -n soans -q WelcomE1234## -r WelcomE1234##
