...
#No need image has been push to public repo
...
./create-rcu-schema.sh -s SOA1 -t soaessosb -d database.soans.svc.cluster.local:1521/PDB1.VCNCHANGE  -i bjlim80/soasuite:12.2.1.4-20.4.2 -n soans -q WelcomE1234## -r WelcomE1234##
